...
# layout
# st.title("Let your Data Speak for you!!")
st.subheader("**:orange[Let your Data Speak for you!!]**")
# st.title("adding comments to acknowledge code breakage")
# st.markdown("Language Translation and Speaking Application, Welcome!!" )
inputtext = st.text_area("**:blue[Input your desired data here]**", height = 200)
...
if len(inputtext) > 0 :
    try:
        ...
        with c1:
            st.text_area("**:orange[Tranlated Content]**", output, height = 200)
        ...
        if choice in speech_langs.values():
            with c2:
                ...
                st.markdown("**:orange[Play Translated Version]**" )
